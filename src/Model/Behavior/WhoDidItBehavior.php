...
class WhoDidItBehavior extends Behavior
{
    ...
    function setup(Model $model, $config = array())
    {
        ...
        //Adding a virtual field to display the full name
        if ($model->alias == 'CreatedBy') {
            $model->virtualFields = array('name' => 'CONCAT(CreatedBy.legal_given_names, " ", CreatedBy.legal_family_name)');
        }
        if ($model->alias == 'ModifiedBy') {
            $model->virtualFields = array('name' => 'CONCAT(ModifiedBy.legal_given_names, " ", ModifiedBy.legal_family_name)');
        }
